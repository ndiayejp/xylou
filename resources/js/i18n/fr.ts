...
export default {
    ...
    difficulties: {
        maths: {
            ...
            multi_step_problems: 'Problèmes à plusieurs étapes',
            fractions: 'Fractions',
            mental_math: 'Calcul mental',
            reading_statements: 'Lire et comprendre un énoncé',
            geometry: 'Géométrie',
            times_tables: 'Tables de multiplication',
            measures: 'Mesures & conversions',
        },
        french: {
            reading_fluency: 'Lecture fluide',
            reading_comprehension: 'Compréhension de texte',
        ...
        sciences: {
            scientific_method: 'Démarche scientifique',
            reading_documents: 'Lire un schéma ou un document',
            science_vocabulary: 'Vocabulaire scientifique',
        ...
        other: {
            ...
            homework_routine: 'Rythme des devoirs',
        },
        daily: {
            discouraged_long: 'Se décourage vite face à un exercice long',
            hesitates_help: 'Hésite à demander de l’aide',
            tired_evening: 'Fatigue en fin de journée',
            concentration: 'Difficultés de concentration',
        },
    },
    goals: {
