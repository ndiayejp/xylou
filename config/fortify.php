...
return [
    ...
    */
    ...
    // Xylou n'utilise que la 2FA de Fortify (ADR 0012) : Breeze gère l'inscription, la connexion
    // et les mots de passe. Les routes Fortify sont désactivées et déclarées dans routes/auth.php.
    'features' => [
