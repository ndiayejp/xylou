...
- **Journal d'audit** (ADR 0014) : chaque action sensible (connexion, 2FA, session enfant, code parent, PIN, suppression de compte) est journalisée avec son auteur et, le cas échéant, l'enfant concerné ; jamais de donnée personnelle. Conservation un an.
...
- `tests/Feature/Identity/AuditLogTest.php` : chaque événement journalisé, absence de donnée personnelle.
